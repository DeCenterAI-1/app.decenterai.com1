...
export default function Page() {
  ...
  return (
    <div className="bg-primary_13 h-screen flex flex-col gap-4 relative">
      ...
      {!loginStart ? <div className="h-[80%] absolute w-full h-full flex-1 flex justify-center items-center">
        <div className="bg-primary_ border border-primary_11 rounded-3xl px-4 py-12 flex justify-center">
          <div className="w-full sm:w-[90%]">
            <div className="text-center flex flex-col justify-between h-[100%]">
              ...
              <div>
                <button
                  className="hover:text-primary_1 border bg-primary_11 flex text-base items-center justify-center gap-4 border-primary_11 hover:border-primary_7 text-primary_7 font-semibold font-primaryArchivo w-full h-12 cursor-pointer rounded-xl"
                  onClick={login}
                >
        ...
        <div className="h-[80%] absolute w-full h-full flex-1 flex justify-center items-center">
          <div className="border border-primary_11 rounded-3xl px-4 py-12 flex justify-center">
            <div className="w-full sm:w-[90%]">
